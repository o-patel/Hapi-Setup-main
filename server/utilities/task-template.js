  ...
  <body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #f2f3f8;" leftmargin="0">
    ...
    let mailHtml = ` 
              ...
              <tr>
                ...
                <th style="padding: 6px;">Created By</th>
    ...
    if (configObj.tasks && configObj.tasks.length) {
        for (let index = 0; index < configObj.tasks.length; index++) {
            ...
            const date = convert(element.date,configObj.timezone)

                const text2 = `                  
                <tr>
              <td style="padding: 6px; white-space: nowrap;">${element.label}</td>
              <td style="padding: 6px; white-space: nowrap;">${configObj.createdBy}</td>
              <td style="padding: 6px; white-space: nowrap;">${date}</td>
              <td style="padding: 6px; white-space: nowrap;">${element.expectedHours}</td>
