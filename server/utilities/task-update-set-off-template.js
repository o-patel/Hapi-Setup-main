...
<p style="font-size: 22px; margin: 0px 0px 18px"> <b> Set off from <span
style="color:#1ed760">${configObj.user}</span></b></p>
    <span style="text-align: left">
        <p style="margin: 13px 0px">Hello sir,</p>
        <p style="margin: 13px 0px">${configObj.user} has set off daily update for date : ${convert(configObj.date, configObj.tz)}</p>
    </span> 
    
    <span style="text-align: left">
        <p style="margin: 13px 0px"><b>Reason:- </b>${configObj.reason}</p>
    </span> 
    ...
    return header + centerText + footer;
